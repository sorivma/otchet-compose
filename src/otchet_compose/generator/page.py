...
class PageSetup:
    """Configures page dimensions, margins, and footer for a Document."""

    @staticmethod
    def apply(doc, hide_first_page_number: bool) -> None:
    ...
    def add_page_number(section) -> None:
        ...
        run = OxmlHelper.add_field_run(paragraph, " PAGE ", "1", dirty=False)
        OxmlHelper.set_font(
            run,
